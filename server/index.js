...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        user: 'essilfiealbert71@gmail.com',
        pass: 'hzoq eoed ecll rirh',
    },
});
...
const uri = "mongodb+srv://essilfie:lupoY219@essilfie.ivec771.mongodb.net/?retryWrites=true&w=majority&appName=essilfie";
...
async function run() {
    try {
        ...
        app.post('/send-email', (req, res) => {
            ...
            const mailOptions = {
                from: 'essilfiealbert71@gmail.com',
                to: email,
